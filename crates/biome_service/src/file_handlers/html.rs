...
/// literal bodies, block comments) are left untouched, since those formatters
/// preserve that content verbatim. Empty lines are also left alone so no
/// trailing whitespace sneaks in.
